  ...
  return (
    <div className={classes.root}>
      ...
      <p>
        ...
        University of California, Santa Barbara. I like to dedicate a lot of my
        time to exploring different areas of computer science and software
      ...
      <p>
        ...
        playing those games, interacting with others who enjoy them as well, and
        using it as a means to test some personal projects. Currently, my stream
        is outfitted with a custom bot that allows viewers to control certain
        IoT devices that I set up. In my case, people can exchange channel
        points (a virtual currency earned only through watch time) to activate a
        strobe light in my face for a number of seconds.
      </p>
      <p>
